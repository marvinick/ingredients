...
import { customPropTypes, createShorthandFactory, getElementType, getUnhandledProps, META, SUI, useKeyOnly, useKeyOrValueAndKey, useValueAndKey } from '../../lib';
...
var Button = function (_Component) {
  ...
  function Button() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Button.__proto__ || Object.getPrototypeOf(Button)).call.apply(_ref, [this].concat(args))), _this), _this.computeElementType = function () {
      ...
      return icon && (labelPosition || _isNil(children) && _isNil(content));
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var hasChildren = !_isNil(children);
