...
import { createHTMLInput, createShorthandFactory, customPropTypes, getElementType, getUnhandledProps, META, partitionHTMLInputProps, SUI, useKeyOnly, useValueAndKey } from '../../lib';
...
var Input = function (_Component) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      // Render Shorthand
      // ----------------------------------------
      var actionElement = Button.create(action, { defaultProps: { className: 'button' } });
