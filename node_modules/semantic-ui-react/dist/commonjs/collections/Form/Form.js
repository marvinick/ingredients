...
var Form = function (_Component) {
  ...
  function Form() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Form.__proto__ || Object.getPrototypeOf(Form)).call.apply(_ref, [this].concat(args))), _this), _this.handleSubmit = function (e) {
      var _this$props = _this.props,
          action = _this$props.action,
          onSubmit = _this$props.onSubmit;

      if (!action) e.preventDefault();
      if (onSubmit) onSubmit(e, (0, _extends3.default)({}, _this.props));
  ...
  (0, _createClass3.default)(Form, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ElementType,
        (0, _extends3.default)({}, rest, { onSubmit: this.handleSubmit, className: classes }),
        children
      );
    }
  }]);
